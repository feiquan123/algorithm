...
extern void _cgoexp_45eb936b1347_go_qsort_compare(void *);

CGO_NO_SANITIZE_THREAD
int go_qsort_compare(void* a, void* b)
{
	...
	_cgo_a.p1 = b;
	_cgo_tsan_release();
	crosscall2(_cgoexp_45eb936b1347_go_qsort_compare, &_cgo_a, 20, _cgo_ctxt);
	_cgo_tsan_acquire();
