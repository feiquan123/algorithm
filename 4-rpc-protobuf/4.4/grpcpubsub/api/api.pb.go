...
var file_api_api_proto_rawDesc = []byte{
	...
	,
}
...
var file_api_api_proto_depIdxs = []int32{
	0, // 0: api.PubSubService.Publish:input_type -> api.String
	0, // 1: api.PubSubService.Subscribe:input_type -> api.String
	0, // 2: api.PubSubService.Publish:output_type -> api.String
	0, // 3: api.PubSubService.Subscribe:output_type -> api.String
...
func (c *pubSubServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/api.PubSubService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pubSubServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PubSubService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PubSubService_serviceDesc.Streams[0], "/api.PubSubService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PubSubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.PubSubService/Publish",
	}
